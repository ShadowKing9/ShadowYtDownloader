...
<details>
    ...
    <br><b><u>This repository cannot be able deploy in heroku due to some reasons.</u></b><br>To deploy this bot in heroku..<br><br>
        ...
        2. Change the URL of 'repository' parameter in <a href="https://github.com/ShadowKing9/ShadowYtDownloader/blob/main/app.json#L7"> app.json</a> to your fork URL.<br>
        3. Change the <a href="https://github.com/ShadowKing9/ShadowYtDownloader/blob/main/README.md?plain=1#L50"> Deploy button URL</a> to your fork URL.<br>
        4. Finally, deploy it from your own fork.<br><br><br>
    <a href="https://heroku.com/deploy?template=https://github.com/ShadowKing9/ShadowYtDownloader">
